...
class Gmail(AuthenticatedService):
    ...
    def send_message(
        ...
        msg_plain: str | None = None, cc: List[str] | None = None,
    ...
    def get_messages(
        ...
        attachments: str = 'reference', include_spam_trash: bool = False
    ) -> List[Message]:
        '''
    ...
    def _create_message(
        self, sender: str, to: str, subject: str = '', msg_html: str = None, msg_plain: str | None = None,
        cc: List[str] | None = None, bcc: List[str] | None = None, attachments: List[str] | None = None,
        signature: bool = False, user_id: str = 'me'
    ) -> dict:
        '''
