...
class Message:
    ...
    def move_from_inbox(self, to: Label | str):
        '''
    ...
    def add_label(self, to_add: Label | str):
        '''
    ...
    def add_labels(self, to_add: List[Label] | List[str]):
        '''
    ...
    def remove_label(self, to_remove: Label | str):
        '''
    ...
    def remove_labels(self, to_remove: List[Label] | List[str]):
        '''
    ...
    def modify_labels(
        self, to_add: Label | str | List[Label] | List[str] | None = None,
        to_remove: Label | str | List[Label] | List[str] | None = None
    ):
        '''
    ...
    def _create_update_labels(
        self, to_add: List[Label] | List[str] | None = None,
