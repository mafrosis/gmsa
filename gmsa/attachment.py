...
class Attachment:
    ...
    '''
    def __init__(
        self, service: googleapiclient.discovery.Resource, user_id: str, msg_id: str, att_id: str,
        filename: str, filetype: str, data: bytes | None = None
    ):
        '''
        Args:
    ...
    def save(self, filepath: str | None = None, overwrite: bool = False):
        '''
